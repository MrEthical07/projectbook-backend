...
type Service interface {
	...
	UpdateCalendarEvent(ctx context.Context, projectID, eventID, actorUserID string, req updateCalendarEventRequest) (map[string]any, error)
...
func (s *service) ListCalendarData(ctx context.Context, projectID string, query listQuery) (map[string]any, error) {
	data, err := s.repo.ListCalendarData(ctx, projectID, query)
	if err != nil {
		return nil, mapServiceError("list calendar", err)
	}
	return data, nil
}

func (s *service) CreateCalendarEvent(ctx context.Context, projectID, actorUserID string, req createCalendarEventRequest) (map[string]any, error) {
	...
	if err != nil {
		return nil, mapServiceError("create calendar event", err)
	}
	return created, nil
}

func (s *service) GetCalendarEvent(ctx context.Context, projectID, eventID string) (map[string]any, error) {
	item, err := s.repo.GetCalendarEvent(ctx, projectID, eventID)
	if err != nil {
		return nil, mapServiceError("get calendar event", err)
	}
	return item, nil
}

func (s *service) UpdateCalendarEvent(ctx context.Context, projectID, eventID, actorUserID string, req updateCalendarEventRequest) (map[string]any, error) {
	if err := req.Validate(); err != nil {
		return nil, err
	}
	...
	if err != nil {
		return nil, mapServiceError("update calendar event", err)
	}
	return updated, nil
}

func (s *service) DeleteCalendarEvent(ctx context.Context, projectID, eventID, actorUserID string) (map[string]any, error) {
	...
	if err != nil {
		return nil, mapServiceError("delete calendar event", err)
	}
	return deleted, nil
}
